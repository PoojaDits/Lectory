        ...
        <div className="relative bg-gradient-to-br from-amber-700 via-amber-800 to-amber-950 rounded-3xl p-8 md:p-16 overflow-hidden">
          ...
          <div className="relative max-w-2xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              ...
              <button className="px-8 py-3.5 bg-amber-500 hover:bg-amber-400 text-amber-950 font-bold rounded-full transition-all hover:scale-105 shadow-lg shadow-amber-600/30 whitespace-nowrap">
                Subscribe
              </button>
            </div>
